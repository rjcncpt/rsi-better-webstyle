...
// Spectrum CSS ends [class*=Release__Wrapper-sc]{}
...
.theme-dark #sidebar .member-presence-menu-popout .popout-item:not(:last-child) {
	background-color: rgb(42, 69, 106) !important;
    border-color: rgb(55 86 129) !important;
}
...
@media only screen and (max-width:500px) {
	...
	.accountReferralHeroBanner{
		padding: var(--orion-layout-spacing-350) 0 calc(var(--orion-layout-spacing-350) + 1rem)!important;
	}
	.c-notification__inner {
		padding: 0 40px 0 40px;
	}
...
#contentbody #layout-system{
	display: flex;
    justify-content: space-between;
    flex-direction: column;
}
[data-cy-id="video__container"] {
	display: none;
}
[data-orion-skin] .accountReferralHeroBanner:after{
	background: none;
}
...
@media only screen and (max-width:500px) {
	...
	[data-orion-skin] .a-stack{
		gap: 10px;
	}
	[data-orion-skin] .a-stack.-vertical.-gap-150.accountReferralRecruitsModal__content{
		overflow: scroll;
	}
	[data-orion-skin] .accountReferralRecruitsModal .swiper-slide, [data-orion-skin].accountReferralRecruitsModal .swiper-slide {
		align-items: flex-start;
	}
	[data-orion-skin] .accountReferralRecruitsModal__navigation, [data-orion-skin].accountReferralRecruitsModal__navigation {
		margin: 0;
	}
	[data-orion-skin] .accountReferralRecruitsModal__content, [data-orion-skin].accountReferralRecruitsModal__content {
		padding: 20px 20px 10px;
	}
}
/* REFERRAL PAGE end */
